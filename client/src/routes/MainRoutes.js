...
const CamSetting = Loadable(lazy(() => import('../pages/settings/dispatchsettings')));
const DispatchSettings = Loadable(lazy(() => import('../pages/settings/dispatchsettings')));
const FloorplanSettings = Loadable(lazy(() => import('../pages/settings/floorplansettings')));
const VersionInfo = Loadable(lazy(() => import('../pages/settings/versioninfo')));
        ...
        >
            <AuthGuard>
                ...
                <Topbar />
                    ...
                    <Route path="/settings/dispatchsettings" component={DispatchSettings} />
                    <Route path="/settings/floorplan" component={FloorplanSettings} />
